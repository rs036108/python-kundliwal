...
class calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=17,bg='#fff',font=('Arial bold',28),textvariable=self.equation,border=4).place(x=0,y=0)
        ...
        Button(width=11, height=4, text='.', relief='flat', bg='cyan', command=lambda: self.show('.')).place(x=180, y=350)
        ...
        Button(width=11, height=4, text='/', relief='flat', bg='cyan', command=lambda: self.show('/')).place(x=270, y=50)
        ...
        Button(width=11, height=4, text='C', relief='flat', command=self.clear).place(x=5,y=350)
