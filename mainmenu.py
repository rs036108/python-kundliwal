...
heading=Label(frame,text="Sign Up",fg='black',bg='white',font=('Times',20,'bold'))
...
def on_leave(e):
    if conform_code.get()=='':
        conform_code.insert(0,'Conform Code')
...
Button(frame,width=39,pady=7,text='Sign Up',bg='#57a1f8',border=0,command=signup).place(x=35,y=280)
label=Label(frame,text="I Have an acount",fg='black',bg='white',font=('Times',9))
